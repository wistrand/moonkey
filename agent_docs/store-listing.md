...
- **On-device icon** — 128×128, full-colour + 64-colour MIP variant — [`docs/icon-128.png`](../docs/icon-128.png), [`docs/icon-128-lc.png`](../docs/icon-128-lc.png) · `make on-device-icon`

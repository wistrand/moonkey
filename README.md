...
- **Moon**: a real lunar photo, soft-terminator shaded for the current phase and rotated to the
  ...
  traces the Moon's above-horizon span (moonrise→moonset), and a dot on the day/night ring marks the
  Moon's separation from the Sun (together at new moon, opposite at full), in the Moon-arc colour.
...
AMOLED, `minApiLevel 4.2.1`: `marq2aviator` (default), `fenix843mm`, `fenix847mm`, `marq2`, `venu3`, `epix2pro47mm`, `epix2`, `fr965`, `fenix8pro47mm` (fēnix 8 Pro / MicroLED).
